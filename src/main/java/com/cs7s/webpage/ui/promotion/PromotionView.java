...
/**
 * The page that shows Promotion Table.
 */
@SpringComponent
...
public class PromotionView extends Panel implements View {
	...
	/**
	 * The constructor of PromotionView.
	 * @param promoRepo the Promotion Table repository.
	 * @param bookingRepo the Booking Table repository.
	 * @param customerRepo the Customer Table repository.
	 */
	 ...
	 * @param event the event that fires when a user enters this view.
	 */
	@Override
	...
	/**
	 * Updates the table based on the Promotion Table in the database.
	 */
	...
	/**
	 * Updates or inserts a tour entity from the Promotion Table in the database.
	 * @param promo the promotion to be saved.
	 */
